...
class WorkoutContainer extends Component {
  ...
  state = {workoutTodayList: [
      ...
      {name: 'Side Plank Abduction Right', id:2, sets: 3, reps: 10, band: 'yellow' },
      {name: '20ft Band Walks', sets: 3, id:3, band: 'blue', misc: 'around ankles'},
  ...
  return this.state.workoutTodayList.map(workout =>{
      return(  <WorkoutTodayCard key={workout.id} workout={workout} handleUrlChange={this.props.handleUrlChange}/>
      )
    });
  };
